...
public val BrandsGroup.AllIcons: ____KtList<ImageVector>
  get() {
    ...
    __AllIcons= listOf(AccessibleIcon, Accusoft, Adn, Adversal, Affiliatetheme, Airbnb, Algolia,
        ...
        FontAwesome, Fonticons, FonticonsFi, FortAwesome, FortAwesomeAlt, Forumbee, Foursquare,
        ...
        Napster, Neos, NfcDirectional, NfcSymbol, Nimblr, Node, NodeJs, Npm, Ns8, Nutritionix,
        OctopusDeploy, Odnoklassniki, Odysee, OldRepublic, Opencart, Openid, Opensuse, Opera,
        ...
        PiedPiperHat, PiedPiperPp, Pinterest, PinterestP, Pix, Pixiv, Playstation, ProductHunt,
        Pushed, Python, Qq, Quinscape, Quora, RProject, RaspberryPi, Ravelry, React, Reacteurope,
        Readme, Rebel, RedRiver, Reddit, RedditAlien, Redhat, Renren, Replyd, Researchgate,
        Resolving, Rev, Rocketchat, Rockrms, Rust, Safari, Salesforce, Sass, Schlix, Screenpal,
        Scribd, Searchengin, Sellcast, Sellsy, Servicestack, Shirtsinbulk, Shoelace, Shopify,
        Shopware, SignalMessenger, Simplybuilt, Sistrix, Sith, Sitrox, Sketch, Skyatlas, Skype,
        Slack, Slideshare, Snapchat, Soundcloud, Sourcetree, SpaceAwesome, Speakap, SpeakerDeck,
        Spotify, SquareBehance, SquareDribbble, SquareFacebook, SquareFontAwesome,
...
public val BrandsGroup.AllIconsNamed: ____KtMap<String, ImageVector>
  get() {
    ...
    __AllIconsNamed= mapOf("accessibleicon" to AccessibleIcon, "accusoft" to Accusoft, "adn" to Adn,
        "adversal" to Adversal, "affiliatetheme" to Affiliatetheme, "airbnb" to Airbnb, "algolia" to
        Algolia, "alipay" to Alipay, "amazon" to Amazon, "amazonpay" to AmazonPay, "amilia" to
        Amilia, "android" to Android, "angellist" to Angellist, "angrycreative" to Angrycreative,
        "angular" to Angular, "appstore" to AppStore, "appstoreios" to AppStoreIos, "apper" to
        Apper, "apple" to Apple, "applepay" to ApplePay, "artstation" to Artstation, "asymmetrik" to
        Asymmetrik, "atlassian" to Atlassian, "audible" to Audible, "autoprefixer" to Autoprefixer,
        "avianex" to Avianex, "aviato" to Aviato, "aws" to Aws, "bandcamp" to Bandcamp, "battlenet"
        to BattleNet, "behance" to Behance, "bilibili" to Bilibili, "bimobject" to Bimobject,
        "bitbucket" to Bitbucket, "bitcoin" to Bitcoin, "bity" to Bity, "blacktie" to BlackTie,
        "blackberry" to Blackberry, "blogger" to Blogger, "bloggerb" to BloggerB, "bluesky" to
        Bluesky, "bluetooth" to Bluetooth, "bluetoothb" to BluetoothB, "bootstrap" to Bootstrap,
        "bots" to Bots, "brave" to Brave, "bravereverse" to BraveReverse, "btc" to Btc, "buffer" to
        ...
        Cloudscale, "cloudsmith" to Cloudsmith, "cloudversify" to Cloudversify, "cmplid" to Cmplid,
        "codepen" to Codepen, "codiepie" to Codiepie, "confluence" to Confluence, "connectdevelop"
        to Connectdevelop, "contao" to Contao, "cottonbureau" to CottonBureau, "cpanel" to Cpanel,
        ...
        DAndDBeyond, "dailymotion" to Dailymotion, "dartlang" to DartLang, "dashcube" to Dashcube,
        "debian" to Debian, "deezer" to Deezer, "delicious" to Delicious, "deploydog" to Deploydog,
        "deskpro" to Deskpro, "dev" to Dev, "deviantart" to Deviantart, "dhl" to Dhl, "diaspora" to
        Diaspora, "digg" to Digg, "digitalocean" to DigitalOcean, "discord" to Discord, "discourse"
        to Discourse, "dochub" to Dochub, "docker" to Docker, "draft2digital" to Draft2digital,
        "dribbble" to Dribbble, "dropbox" to Dropbox, "drupal" to Drupal, "dyalog" to Dyalog,
        "earlybirds" to Earlybirds, "ebay" to Ebay, "edge" to Edge, "edgelegacy" to EdgeLegacy,
        "elementor" to Elementor, "ello" to Ello, "ember" to Ember, "empire" to Empire, "envira" to
        Envira, "erlang" to Erlang, "ethereum" to Ethereum, "etsy" to Etsy, "evernote" to Evernote,
        "expeditedssl" to Expeditedssl, "facebook" to Facebook, "facebookf" to FacebookF,
        "facebookmessenger" to FacebookMessenger, "fantasyflightgames" to FantasyFlightGames,
        "fedex" to Fedex, "fedora" to Fedora, "figma" to Figma, "firefox" to Firefox,
        "firefoxbrowser" to FirefoxBrowser, "firstorder" to FirstOrder, "firstorderalt" to
        FirstOrderAlt, "firstdraft" to Firstdraft, "flickr" to Flickr, "flipboard" to Flipboard,
        "flutter" to Flutter, "fly" to Fly, "fontawesome" to FontAwesome, "fonticons" to Fonticons,
        "fonticonsfi" to FonticonsFi, "fortawesome" to FortAwesome, "fortawesomealt" to
        FortAwesomeAlt, "forumbee" to Forumbee, "foursquare" to Foursquare, "freecodecamp" to
        FreeCodeCamp, "freebsd" to Freebsd, "fulcrum" to Fulcrum, "galacticrepublic" to
        GalacticRepublic, "galacticsenate" to GalacticSenate, "getpocket" to GetPocket, "gg" to Gg,
        "ggcircle" to GgCircle, "git" to Git, "gitalt" to GitAlt, "github" to Github, "githubalt" to
        GithubAlt, "gitkraken" to Gitkraken, "gitlab" to Gitlab, "gitter" to Gitter, "glide" to
        Glide, "glideg" to GlideG, "gofore" to Gofore, "golang" to Golang, "goodreads" to Goodreads,
        "goodreadsg" to GoodreadsG, "google" to Google, "googledrive" to GoogleDrive, "googlepay" to
        GooglePay, "googleplay" to GooglePlay, "googleplus" to GooglePlus, "googleplusg" to
        GooglePlusG, "googlescholar" to GoogleScholar, "googlewallet" to GoogleWallet, "gratipay" to
        Gratipay, "grav" to Grav, "gripfire" to Gripfire, "grunt" to Grunt, "guilded" to Guilded,
        "gulp" to Gulp, "hackernews" to HackerNews, "hackerrank" to Hackerrank, "hashnode" to
        Hashnode, "hips" to Hips, "hireahelper" to HireAHelper, "hive" to Hive, "hooli" to Hooli,
        "hornbill" to Hornbill, "hotjar" to Hotjar, "houzz" to Houzz, "html5" to Html5, "hubspot" to
        Hubspot, "ideal" to Ideal, "imdb" to Imdb, "instagram" to Instagram, "instalod" to Instalod,
        "intercom" to Intercom, "internetexplorer" to InternetExplorer, "invision" to Invision,
        "ioxhost" to Ioxhost, "itchio" to ItchIo, "itunes" to Itunes, "itunesnote" to ItunesNote,
        "java" to Java, "jediorder" to JediOrder, "jenkins" to Jenkins, "jira" to Jira, "joget" to
        Joget, "joomla" to Joomla, "js" to Js, "jsfiddle" to Jsfiddle, "jxl" to Jxl, "kaggle" to
        Kaggle, "keybase" to Keybase, "keycdn" to Keycdn, "kickstarter" to Kickstarter,
        "kickstarterk" to KickstarterK, "korvue" to Korvue, "laravel" to Laravel, "lastfm" to
        Lastfm, "leanpub" to Leanpub, "less" to Less, "letterboxd" to Letterboxd, "line" to Line,
        "linkedin" to Linkedin, "linkedinin" to LinkedinIn, "linode" to Linode, "linux" to Linux,
        "lyft" to Lyft, "magento" to Magento, "mailchimp" to Mailchimp, "mandalorian" to
        Mandalorian, "markdown" to Markdown, "mastodon" to Mastodon, "maxcdn" to Maxcdn, "mdb" to
        Mdb, "medapps" to Medapps, "medium" to Medium, "medrt" to Medrt, "meetup" to Meetup,
        "megaport" to Megaport, "mendeley" to Mendeley, "meta" to Meta, "microblog" to Microblog,
        "microsoft" to Microsoft, "mintbit" to Mintbit, "mix" to Mix, "mixcloud" to Mixcloud,
        "mixer" to Mixer, "mizuni" to Mizuni, "modx" to Modx, "monero" to Monero, "napster" to
        Napster, "neos" to Neos, "nfcdirectional" to NfcDirectional, "nfcsymbol" to NfcSymbol,
        "nimblr" to Nimblr, "node" to Node, "nodejs" to NodeJs, "npm" to Npm, "ns8" to Ns8,
        "nutritionix" to Nutritionix, "octopusdeploy" to OctopusDeploy, "odnoklassniki" to
        Odnoklassniki, "odysee" to Odysee, "oldrepublic" to OldRepublic, "opencart" to Opencart,
        "openid" to Openid, "opensuse" to Opensuse, "opera" to Opera, "optinmonster" to
        OptinMonster, "orcid" to Orcid, "osi" to Osi, "padlet" to Padlet, "page4" to Page4,
        "pagelines" to Pagelines, "palfed" to Palfed, "patreon" to Patreon, "paypal" to Paypal,
        "perbyte" to Perbyte, "periscope" to Periscope, "phabricator" to Phabricator,
        "phoenixframework" to PhoenixFramework, "phoenixsquadron" to PhoenixSquadron, "php" to Php,
        "piedpiper" to PiedPiper, "piedpiperalt" to PiedPiperAlt, "piedpiperhat" to PiedPiperHat,
        "piedpiperpp" to PiedPiperPp, "pinterest" to Pinterest, "pinterestp" to PinterestP, "pix" to
        Pix, "pixiv" to Pixiv, "playstation" to Playstation, "producthunt" to ProductHunt, "pushed"
        to Pushed, "python" to Python, "qq" to Qq, "quinscape" to Quinscape, "quora" to Quora,
        "rproject" to RProject, "raspberrypi" to RaspberryPi, "ravelry" to Ravelry, "react" to
        React, "reacteurope" to Reacteurope, "readme" to Readme, "rebel" to Rebel, "redriver" to
        RedRiver, "reddit" to Reddit, "redditalien" to RedditAlien, "redhat" to Redhat, "renren" to
        Renren, "replyd" to Replyd, "researchgate" to Researchgate, "resolving" to Resolving, "rev"
        to Rev, "rocketchat" to Rocketchat, "rockrms" to Rockrms, "rust" to Rust, "safari" to
        Safari, "salesforce" to Salesforce, "sass" to Sass, "schlix" to Schlix, "screenpal" to
        Screenpal, "scribd" to Scribd, "searchengin" to Searchengin, "sellcast" to Sellcast,
        "sellsy" to Sellsy, "servicestack" to Servicestack, "shirtsinbulk" to Shirtsinbulk,
        "shoelace" to Shoelace, "shopify" to Shopify, "shopware" to Shopware, "signalmessenger" to
        SignalMessenger, "simplybuilt" to Simplybuilt, "sistrix" to Sistrix, "sith" to Sith,
        "sitrox" to Sitrox, "sketch" to Sketch, "skyatlas" to Skyatlas, "skype" to Skype, "slack" to
        Slack, "slideshare" to Slideshare, "snapchat" to Snapchat, "soundcloud" to Soundcloud,
        "sourcetree" to Sourcetree, "spaceawesome" to SpaceAwesome, "speakap" to Speakap,
        "speakerdeck" to SpeakerDeck, "spotify" to Spotify, "squarebehance" to SquareBehance,
        "squaredribbble" to SquareDribbble, "squarefacebook" to SquareFacebook, "squarefontawesome"
        to SquareFontAwesome, "squarefontawesomestroke" to SquareFontAwesomeStroke, "squaregit" to
        SquareGit, "squaregithub" to SquareGithub, "squaregitlab" to SquareGitlab,
        "squaregoogleplus" to SquareGooglePlus, "squarehackernews" to SquareHackerNews,
        "squareinstagram" to SquareInstagram, "squarejs" to SquareJs, "squarelastfm" to
        SquareLastfm, "squareletterboxd" to SquareLetterboxd, "squareodnoklassniki" to
        SquareOdnoklassniki, "squarepiedpiper" to SquarePiedPiper, "squarepinterest" to
        SquarePinterest, "squarereddit" to SquareReddit, "squaresnapchat" to SquareSnapchat,
        "squaresteam" to SquareSteam, "squarethreads" to SquareThreads, "squaretumblr" to
        SquareTumblr, "squaretwitter" to SquareTwitter, "squareupwork" to SquareUpwork,
        "squareviadeo" to SquareViadeo, "squarevimeo" to SquareVimeo, "squarewebawesome" to
        SquareWebAwesome, "squarewebawesomestroke" to SquareWebAwesomeStroke, "squarewhatsapp" to
        SquareWhatsapp, "squarextwitter" to SquareXTwitter, "squarexing" to SquareXing,
        "squareyoutube" to SquareYoutube, "squarespace" to Squarespace, "stackexchange" to
        StackExchange, "stackoverflow" to StackOverflow, "stackpath" to Stackpath, "staylinked" to
        Staylinked, "steam" to Steam, "steamsymbol" to SteamSymbol, "stickermule" to StickerMule,
        "strava" to Strava, "stripe" to Stripe, "stripes" to StripeS, "stubber" to Stubber,
        "studiovinari" to Studiovinari, "stumbleupon" to Stumbleupon, "stumbleuponcircle" to
        StumbleuponCircle, "superpowers" to Superpowers, "supple" to Supple, "suse" to Suse, "swift"
        to Swift, "symfony" to Symfony, "teamspeak" to Teamspeak, "telegram" to Telegram,
        "tencentweibo" to TencentWeibo, "theredyeti" to TheRedYeti, "themeco" to Themeco,
        "themeisle" to Themeisle, "thinkpeaks" to ThinkPeaks, "threads" to Threads, "tiktok" to
        Tiktok, "tradefederation" to TradeFederation, "trello" to Trello, "tumblr" to Tumblr,
        "twitch" to Twitch, "twitter" to Twitter, "typo3" to Typo3, "uber" to Uber, "ubuntu" to
        Ubuntu, "uikit" to Uikit, "umbraco" to Umbraco, "uncharted" to Uncharted, "uniregistry" to
        Uniregistry, "unity" to Unity, "unsplash" to Unsplash, "untappd" to Untappd, "ups" to Ups,
        "upwork" to Upwork, "usb" to Usb, "usps" to Usps, "ussunnah" to Ussunnah, "vaadin" to
        Vaadin, "viacoin" to Viacoin, "viadeo" to Viadeo, "viber" to Viber, "vimeo" to Vimeo,
        "vimeov" to VimeoV, "vine" to Vine, "vk" to Vk, "vnv" to Vnv, "vuejs" to Vuejs,
        "watchmanmonitoring" to WatchmanMonitoring, "waze" to Waze, "webawesome" to WebAwesome,
        "webflow" to Webflow, "weebly" to Weebly, "weibo" to Weibo, "weixin" to Weixin, "whatsapp"
        to Whatsapp, "whmcs" to Whmcs, "wikipediaw" to WikipediaW, "windows" to Windows,
        "wirsindhandwerk" to Wirsindhandwerk, "wix" to Wix, "wizardsofthecoast" to
        WizardsOfTheCoast, "wodu" to Wodu, "wolfpackbattalion" to WolfPackBattalion, "wordpress" to
        Wordpress, "wordpresssimple" to WordpressSimple, "wpbeginner" to Wpbeginner, "wpexplorer" to
        Wpexplorer, "wpforms" to Wpforms, "wpressr" to Wpressr, "xtwitter" to XTwitter, "xbox" to
        Xbox, "xing" to Xing, "ycombinator" to YCombinator, "yahoo" to Yahoo, "yammer" to Yammer,
        "yandex" to Yandex, "yandexinternational" to YandexInternational, "yarn" to Yarn, "yelp" to
        Yelp, "yoast" to Yoast, "youtube" to Youtube, "zhihu" to Zhihu, "_42group" to _42Group,
        "_500px" to _500px)
    return __AllIconsNamed!!
  }
